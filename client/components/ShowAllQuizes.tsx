        ...
        {filteredQuizes.map((quiz, idx) => {
          return (
            <Button
              ...
              className="w-full relative h-40 bg-rose-50 hover:bg-rose-100 flex transition-all duration-200 ease-in-out items-start justify-between flex-col rounded-lg p-4"
            >
